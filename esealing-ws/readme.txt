...
The classes in the "esealing-model" project are based on the definitions in this standard.
...
There is also a StubHsm.java containing a harcoded keystore, in case no HSM is present.
